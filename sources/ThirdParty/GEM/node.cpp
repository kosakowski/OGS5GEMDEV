...
#ifndef IPMGEMPLUGIN
    profil->generate_ThermoFun_input_file_stream( stream, compact );
#else
...
#ifdef IPMGEMPLUGIN
    internal_multi.reset(new TMulti(this));
...
#ifndef IPMGEMPLUGIN
        CalcTime = profil->ComputeEquilibriumState( /*NumPrecLoops,*/ NumIterFIA, NumIterIPM );
#else
