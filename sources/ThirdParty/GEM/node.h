...
protected:
    ...
    TMulti* multi_base = nullptr;     // GEM IPM3 implementation class
    std::shared_ptr<TMulti> internal_multi;
...
public:
    ...
    void  write_ThermoFun_format_stream(std::iostream&  stream, bool compact);
