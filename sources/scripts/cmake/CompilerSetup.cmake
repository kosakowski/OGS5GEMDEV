...
if(COMPILER_IS_GCC)
	...
	if( NOT CMAKE_BUILD_TYPE STREQUAL "Debug" )
		if (OGS_FEM_PETSC_GEMS)
			set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O2 -DNDEBUG -std=c++14")
		else()
			set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O3 -DNDEBUG -std=c++14")
		endif()
	else()
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -fsanitize=address -std=c++14")
	endif()
